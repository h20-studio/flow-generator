        ...
        prompts.forEach((p) => {
            ...
            card.innerHTML = `
                ...
                <div class="prompt-content">
                    ...
                    <p class="prompt-consistency">${p.consistency}</p>
                    <p class="prompt-negative">${p.negativePrompt}</p>
                </div>
                <button class="copy-btn" onclick="copyPrompt(this, '${encodeURIComponent(p.fullPrompt)}')">
                    📋 Copy
                </button>
            `;
